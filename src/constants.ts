...
export const AVAILABLE_DISK_SPACE_MONITOR_CRON =
  secretsEnv.AVAILABLE_DISK_SPACE_MONITOR_CRON || ''
...
export const HFP_MONITOR_PULSAR_BOOKIE_DISK_SPACE_PORT =
  secretsEnv.HFP_MONITOR_PULSAR_BOOKIE_DISK_SPACE_PORT || ''
